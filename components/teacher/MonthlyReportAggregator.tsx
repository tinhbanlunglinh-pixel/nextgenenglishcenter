...
export const MonthlyReportAggregator: React.FC<MonthlyReportAggregatorProps> = ({ onOpenAnnualReport }) => {
  ...
  const [centerName, setCenterName] = useState<string>('NEXTGEN ENGLISH');
    ...
    if (existing) {
      ...
      if (syncResult.syncedCount > 0 || needsScheduleSync) {
        saveMonthlyReport({
          ...
          month: selectedMonth,
          year: selectedYear,
          centerName: existing.centerName || 'NEXTGEN ENGLISH',
