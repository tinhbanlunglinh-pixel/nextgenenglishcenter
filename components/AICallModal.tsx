    ...
    try {
      ...
      const sessionPromise = ai.live.connect({
        ...
        config: {
          ...
          systemInstruction: `You are Nextgen Teacher, a friendly polyglot English teacher at "NEXTGEN ENGLISH" (Learn English, Lead the way). 
      ...
      <div className="bg-white rounded-[3.5rem] p-10 md:p-14 max-w-lg w-full relative overflow-hidden shadow-2xl border-[12px] border-brand-100 ring-4 ring-white/20">
        ...
        <div className="flex flex-col items-center justify-center space-y-10">
            <div className="text-center">
                ...
                <h3 className="text-3xl font-black text-slate-800 font-sans mb-2 tracking-tight">Speak with Nextgen Teacher</h3>
            ...
            <div className="min-h-[2rem] text-center">
                {status === 'connecting' && <p className="text-brand-500 font-black animate-pulse">Connecting to Nextgen Teacher...</p>}
                {status === 'connected' && <p className={`font-black text-2xl tracking-tight transition-colors ${isSpeaking ? 'text-brand-700' : 'text-emerald-600'}`}>{isSpeaking ? "Nextgen Teacher is speaking..." : "Listening to you..."}</p>}
