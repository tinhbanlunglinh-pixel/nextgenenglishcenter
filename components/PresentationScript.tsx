...
export const PresentationScriptView: React.FC<PresentationScriptProps> = ({ script, studentName }) => {
  ...
  const startRecording = async () => {
    try {
      ...
      alert("Bé hãy bật Micro nhé! Nextgen không nghe thấy con nói."); 
    }
  };
  ...
  const downloadCert = async () => {
    ...
    try {
      ...
      link.download = `Speaking-Cert-Nextgen-${studentName || 'Student'}.png`;
      link.href = dataUrl;
      link.click();
    } catch (err) {
      ...
      <div className="bg-white rounded-[4rem] shadow-2xl border-[15px] border-emerald-50 p-10 md:p-16 relative overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-10 border-b-4 border-emerald-100 pb-8 gap-6">
          <div className="text-left">
            ...
            <p className="text-emerald-500 font-bold italic">Luyện tập cùng Nextgen AI nhé!</p>
          </div>
          <button 
        ...
        {isEvaluating && (
          <div className="flex flex-col items-center gap-4 animate-pulse">
            <div className="text-center space-y-4">
              <div className="w-20 h-20 border-8 border-emerald-400 border-t-transparent rounded-full animate-spin mx-auto"></div>
              <p className="text-emerald-300 font-black text-3xl uppercase tracking-widest">Nextgen AI đang chấm điểm...</p>
            </div>
          </div>
        )}
        ...
        <div className="fixed inset-0 z-[100] bg-black/98 flex flex-col items-center justify-center p-8 overflow-y-auto animate-fade-in">
           ...
           <div ref={certRef} className="w-[1200px] h-[850px] bg-white border-[50px] border-emerald-50 p-24 flex flex-col items-center relative shadow-2xl shrink-0">
              ...
              <div className="flex flex-col items-center mb-10">
                ...
                <h2 className="text-2xl font-black text-emerald-800 uppercase tracking-[0.4em] font-sans mb-2">TRUNG TÂM NGOẠI NGỮ NEXTGEN - UÔNG BÍ</h2>
              ...
              <div className="w-full flex justify-between items-end mt-auto px-10">
                 <div className="text-left">
                    <p className="text-[10px] font-black text-slate-200 uppercase tracking-widest">ID: SPEAK-NEXTGEN-{Date.now()}</p>
                    <p className="text-2xl font-black text-emerald-700 uppercase tracking-[0.2em] mt-2">Learn English - Lead the way</p>
                 </div>
                 <div className="text-right">
                    <div className="text-center">
                        ...
                        <p className="text-sm font-black text-emerald-500 uppercase tracking-widest">Ban Giám Đốc</p>
                    </div>
