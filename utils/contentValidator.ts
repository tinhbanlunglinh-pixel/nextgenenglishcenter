/**
 * Content Validator & Pedagogical Quality Firewall (Nextgen AI)
 * 
...
// ============================================================================
// 2. PEDAGOGICAL SANITIZATION & SINGLE-CHOICE GUARANTEE (NEXTGEN FIREWALL)
// ============================================================================
...
export const validateAndSanitizePracticeContent = (
  ...
  const readingMCPassage = rawMega.readingMCPassage || core?.reading?.passage || 'We study English at Nextgen English center every day.';
