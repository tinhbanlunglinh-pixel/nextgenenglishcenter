...
const sanitizeFilename = (name: string): string => {
  return name.replace(/[\\/:*?"<>|]/g, '_').trim() || 'Bai_Tap_Tieng_Anh_Nextgen';
};
...
<body>
  <table class="header-table">
    <tr>
      <td style="width: 55%;">
        <div class="school-title">TRUNG TÂM NGOẠI NGỮ NEXTGEN - UÔNG BÍ</div>
...
<body>
  ...
  <div class="teacher-note">
    <strong>💬 Lời dặn dò của Trung tâm Nextgen:</strong> "${assignment.teacherNote}"
  </div>
  ` : ''}
