...
export enum LoadingStep {
  ...
  GENERATING_AUDIO = 'Creating Nextgen teacher\'s voice...',
  COMPLETED = 'Completed!'
}
...
export interface Assignment {
  ...
  teacherNote?: string;     // Lời dặn dò của giáo viên Nextgen
...
export interface MonthlyReport {
  ...
  centerName: string;        // e.g. "NEXTGEN ENGLISH"
...
export interface StudentAnnualScore {
  ...
  teacherRemarks?: string;                     // Lời phê tổng kết năm của giáo viên Nextgen
}
